...
import cn.itstar.es.office.search.common.utils.RedisUtils;
import cn.itstar.es.office.search.shiro.util.SerializableUtils;
...
public class UserSessionDAO extends EnterpriseCacheSessionDAO {
    ...
    private static final String SHIRO_SESSION_ID = "es-search-shiro-session-id_";
