...
public class LoginLogAspect {
     ...
     * @param retValue
     */
    @AfterReturning(pointcut = "execution(* cn.itstar.es.office.search.shiro.controller.SysLoginController.login(..))", returning = "retValue")
     ...
     * @param joinPoint
     */
    @Before("execution(* cn.itstar.es.office.search.shiro.controller.SysLoginController.logout(..))")
